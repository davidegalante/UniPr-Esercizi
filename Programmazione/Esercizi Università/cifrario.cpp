...
int main()
{
    ...
    a = (a >= 97 && a <= 122) ? (a+3) : 63; //Cifro primo numero, sostituisco carattere non valido con '?' (63, ascii table)
    b = (b >= 97 && b <= 122) ? (b+3) : 63; //Cifro secondo numero, sostituisco carattere con '?' (63, ascii table)
    c = (c >= 97 && c <= 122) ? (c+3) : 63; //Cifro terzo numero, sostituisco carattere con '?' (63, ascii table)
